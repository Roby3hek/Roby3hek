...
В качестве первого проекта, со всеми технологиями, которые требуются при устройстве для Java разработчика, я выбрал разработку Telegram бота для учета финансов, пользователь может добавлять доходы и расходы и отслеживать свои траты, экспортировать документ в виде таблицы и т.д. Подробнее можно ознакомиться в репозитории [Roby3hek/financeBotForJava](https://github.com/Roby3hek/financeBotForJava).
